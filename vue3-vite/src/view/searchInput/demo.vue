<template>
  <Divider>自定义modal</Divider>
  <Button @click="clickButton">Click Me</Button>
  <Divider>v-focus</Divider>
  <Input v-focus />
...
import { Modal, Input, InputSearch, TreeSelect, Tree, Divider, Button } from 'ant-design-vue';
...
export default defineComponent({
  components: { ModalCom, Modal, HeartFilled, Input, TreeSelect, Tree, InputSearch, Divider, Button },
