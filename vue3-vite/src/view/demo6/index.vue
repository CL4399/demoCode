<template>
    <div class="role-content">
        <Button @click="clickF">+</Button>
        <Button @click="clickS">-</Button>
        <RoleAuthority id="RoleAuthority" :checkedKeys="checkedKeys" :data="treeData" :treeObj="treeObj"></RoleAuthority>
...
export default defineComponent({
    components: { RoleAuthority, Input, Button,TreeSearchDemo },
    setup(props: any, { emit }: any) {
        ...
        const clickF = () => {
            let dom: HTMLElement = document.getElementById("RoleAuthority") as HTMLElement
            // @ts-ignore
            dom.style.scale = 0.001
        }
        const clickS = () => {
            let dom: HTMLElement = document.getElementById("RoleAuthority") as HTMLElement
            // @ts-ignore
        ...
        return { ...toRefs(dataInfo), clickOne, clickF, clickS }
    },
})
</script>
