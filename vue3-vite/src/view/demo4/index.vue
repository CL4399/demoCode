<template>
    <div class="demo4">
        ...
        <div>
            <div>color</div>
            <ButtonCom color="red">color</ButtonCom>
        </div>
...
import { DeleteOutlined, AlertOutlined, LinkOutlined, HeartFilled } from "@ant-design/icons-vue"
import Loading from "./Button/Loading"
export default defineComponent({
    components: { IndexCom, Button, Input, ButtonCom, DeleteOutlined, AlertOutlined, LinkOutlined, HeartFilled, Loading },
    setup(props: any, { emit }: any) {
        ...
        return { clickMe, inheritAttrs: true, fun, buttonComClick, clickIconLeft, clickIconRight }
    },
})
</script>
<style scoped>
