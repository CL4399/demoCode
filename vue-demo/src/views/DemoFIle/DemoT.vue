<template>
  <div>
    <div id="echarts-demo" style="width: 100%; height: 500px"></div>
    <div :style="9 | dataFilter">{{ 9 | dataFilter }}----{{ 20 | dataFilter }}</div>
    <div :style="11 | dataFilter">{{ 9 | dataFilter }}----{{ 20 | dataFilter }}</div>
    <div v-test="123">123123</div>
    <svg-icon class="back-class" iconClass="back" style="width: 100px; height: 100px"></svg-icon>
    <svg-icon class="delete-class" iconClass="delete" style="width: 100px; height: 100px"></svg-icon>
  </div>
</template>
<script>
export default {
  ...
  methods: {
    init() {
      ...
      this.mychart = this.$echarts.init(document.getElementById('echarts-demo'));
      this.mychart.setOption(options);
    },
  },
  filters: {
    dataFilter: (val) => {
      return val < 10 ? 'color:red;display:none' : 'color:yellowgreen';
    },
  },
  directives: {
    test: {
